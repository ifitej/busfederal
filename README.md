...
En el caso que no quieras integrar mediante la capa de servicios de BUS Federal, podes comenzar a utilizar las funciones del BUS desde un portal web disponible en **https://portal-qa.bus-justicia.org.ar**. Nuestro portal no gestiona la identidad de los usuarios de los organismos externos, para eso proponemos un modelo de federacion de identidad en donde integramos mediante federacion con el protocolo OIDC nuestro sistema IAM con el de cada organismo que quiera integrar. En el caso que no dispongan de u sistema IAM, dejamos en este repositorio un instructivo completo sobre como desplegar y configurar un IAM de codigo libre. El doumento esta aca **[(https://github.com/ifitej/busfederal/blob/main/LAB%20-%20Acceso%20al%20Portal%20del%20Bus%20Federal%20de%20Justicia.pdf))**.
